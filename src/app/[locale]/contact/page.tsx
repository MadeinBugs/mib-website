							...
							<div className="space-y-4">
								...
								<div className="flex flex-col items-center space-y-3">
									...
									<a
										...
										className="inline-block px-6 py-3 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition-colors duration-200 hover:scale-105 transform"
									>
										{locale === 'en' ? 'View Open Positions' : 'Ver Vagas Abertas'}
									</a>
								</div>
							</div>
						</div>
