		...
		<div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-50">
			...
			<section className="px-6 py-20 max-w-5xl mx-auto text-center">
				...
				<div className="flex flex-col sm:flex-row gap-4 justify-center">
					<Link
						...
						className="inline-block px-8 py-4 bg-[#04c597] text-white font-bold text-lg rounded-lg hover:bg-[#036b54] transition-colors shadow-lg"
					>
			...
			<section className="px-6 py-16">
				<div className="max-w-5xl mx-auto">
					<h2 className="text-2xl font-bold text-neutral-800 mb-10 text-center">
					...
					<div className="grid md:grid-cols-4 gap-6">
						{(locale === 'pt-BR'
							...
							<div key={item.step} className="text-center">
								<div className="w-10 h-10 rounded-full bg-[#04c597] text-white font-bold flex items-center justify-center mx-auto mb-3">
									{item.step}
								</div>
			...
			<section className="px-6 py-16">
				<div className="max-w-4xl mx-auto text-center">
					...
					<div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm text-neutral-500">
						{['Umami Analytics', 'n8n Automation', 'Twenty CRM', 'Uptime Kuma', 'Cal.com', 'Shlink'].map((tool) => (
							<div key={tool} className="p-4 bg-white rounded-lg border border-neutral-200">
								{tool}
							</div>
						))}
					</div>
