...
export default function PlayerGallery({
	...
	return (
		<>
			<div className="mb-8">
				<div role="heading" aria-level={1} className="text-center sm:text-left" style={{ fontFamily: "var(--font-amatic), cursive", fontSize: 'clamp(3rem, 4vw + 1rem, 4rem)', fontWeight: 700, color: '#04c597', textShadow: '-1px 1px 0px #016a50' }}>
